...
enum {
    ...
    LINE_44_1_BACKEND = SLIMBUS_5_RX ,
    HEADPHONE_BACKEND,
    ...
    SPDIF_RX_BACKEND,
    OPTICAL_RX_BACKEND,
    PRIM_META_MI2S_RX_BACKEND,
    SEC_META_MI2S_RX_BACKEND,
    PRIM_MI2S_RX_BACKEND,
    MAX_RX_CODEC_BACKENDS = PRIM_MI2S_RX_BACKEND,
    /* TX BE follows RX BE */
    SLIMBUS_0_TX,
...
#define TX_VOICE_FLUENCE_PRO_VC 0x10F35
