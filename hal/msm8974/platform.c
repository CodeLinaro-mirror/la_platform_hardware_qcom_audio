...
#define PLATFORM_INFO_XML_PATH_SCUBA_IDP "/etc/audio_platform_info_scuba.xml"
#else
...
static const char * const device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_OUT_ECALL_HANDSET] = "voice-handset",
    [SND_DEVICE_OUT_ECALL_SPEAKER] = "voice-speaker",
    [SND_DEVICE_OUT_ECALL_HEADPHONES] = "voice-headphones",
    ...
    [SND_DEVICE_IN_ECALL_VOICE_DMIC] = "voice-dmic-ef",
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC] = "dmic-endfire",
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC_AEC] = "dmic-endfire",
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC_NS] = "dmic-endfire",
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC_AEC_NS] = "dmic-endfire",
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC] = "speaker-dmic-endfire",
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC_AEC] = "speaker-dmic-endfire",
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC_NS] = "speaker-dmic-endfire",
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC_AEC_NS] = "speaker-dmic-endfire"
};
...
static int acdb_device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_IN_ECALL_VOICE_DMIC] = 41,
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC] = 41,
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC_AEC] = 109,
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC_NS] = 110,
    [SND_DEVICE_IN_ECALL_HANDSET_DMIC_AEC_NS] = 111,
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC] = 43,
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC_AEC] = 115,
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC_NS] = 116,
    [SND_DEVICE_IN_ECALL_SPEAKER_DMIC_AEC_NS] = 117,
};
...
static struct name_to_index snd_device_name_index[SND_DEVICE_MAX] = {
    ...
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_VOICE_DMIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_HANDSET_DMIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_HANDSET_DMIC_AEC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_HANDSET_DMIC_NS)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_HANDSET_DMIC_AEC_NS)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_SPEAKER_DMIC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_SPEAKER_DMIC_AEC)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_SPEAKER_DMIC_NS)},
    {TO_NAME_INDEX(SND_DEVICE_IN_ECALL_SPEAKER_DMIC_AEC_NS)},
};
...
static void set_platform_defaults(struct platform_data * my_data)
{
    ...
    hw_interface_table[SND_DEVICE_OUT_ECALL_HANDSET] = strdup("SLIMBUS_0_RX");
    ...
    hw_interface_table[SND_DEVICE_OUT_ECALL_SPEAKER] = strdup("SLIMBUS_0_RX");
    ...
    hw_interface_table[SND_DEVICE_OUT_ECALL_HEADPHONES] = strdup("SLIMBUS_6_RX");
