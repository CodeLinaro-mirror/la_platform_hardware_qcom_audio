...
$(shell python $(SCRIPT) --generate combine --base $(BASE_PATH)/mixer_paths_base.xml --overlay $(OVERLAY_PATH)/mixer_paths_yupikidp_overlay.xml $(OVERLAY_PATH)/mixer_paths_yupikqrd_overlay.xml $(OVERLAY_PATH)/mixer_paths_yupikidprb3_overlay.xml $(OVERLAY_PATH)/mixer_paths_yupikidprb3_vk_overlay.xml $(OVERLAY_PATH)/mixer_paths_yupikidpaio_overlay.xml $(OVERLAY_PATH)/mixer_paths_yupikidpiot_overlay.xml $(OVERLAY_PATH)/mixer_paths_yupikidpcontroller_overlay.xml --out_dir $(TARGET_PATH) --out mixer_paths_yupikidp.xml mixer_paths_yupikqrd.xml mixer_paths_yupikidprb3.xml mixer_paths_yupikidprb3_vk.xml mixer_paths_yupikidpaio.xml mixer_paths_yupikidpiot.xml mixer_paths_yupikidpcontroller.xml)

$(shell python $(SCRIPT) --generate combine --base $(BASE_PATH)/sound_trigger_mixer_paths_base.xml --overlay $(OVERLAY_PATH)/sound_trigger_mixer_paths_yupikidp_overlay.xml $(OVERLAY_PATH)/sound_trigger_mixer_paths_yupikqrd_overlay.xml $(OVERLAY_PATH)/sound_trigger_mixer_paths_yupikidprb3_overlay.xml $(OVERLAY_PATH)/sound_trigger_mixer_paths_yupikidprb3_vk_overlay.xml $(OVERLAY_PATH)/sound_trigger_mixer_paths_yupikidpaio_overlay.xml $(OVERLAY_PATH)/sound_trigger_mixer_paths_yupikidpiot_overlay.xml $(OVERLAY_PATH)/sound_trigger_mixer_paths_yupikidpcontroller_overlay.xml --out_dir $(TARGET_PATH) --out sound_trigger_mixer_paths_yupikidp.xml sound_trigger_mixer_paths_yupikqrd.xml sound_trigger_mixer_paths_yupikidprb3.xml sound_trigger_mixer_paths_yupikidprb3_vk.xml sound_trigger_mixer_paths_yupikidpaio.xml sound_trigger_mixer_paths_yupikidpiot.xml sound_trigger_mixer_paths_yupikidpcontroller.xml)
...
PRODUCT_COPY_FILES += \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/lahaina/audio_platform_info_yupikidprb3_vk.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_$(DEVICE_SKU)/audio_platform_info_yupikidprb3_vk.xml \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/lahaina/audio_platform_info_yupikidpcontroller.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_$(DEVICE_SKU)/audio_platform_info_yupikidpcontroller.xml \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/lahaina/sound_trigger_mixer_paths_yupikidprb3_vk.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_$(DEVICE_SKU)/sound_trigger_mixer_paths_yupikidprb3_vk.xml \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/lahaina/sound_trigger_mixer_paths_yupikidpcontroller.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_$(DEVICE_SKU)/sound_trigger_mixer_paths_yupikidpcontroller.xml \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/lahaina/mixer_paths_yupikidprb3_vk.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_$(DEVICE_SKU)/mixer_paths_yupikidprb3_vk.xml \
    ...
    vendor/qcom/opensource/audio-hal/primary-hal/configs/lahaina/mixer_paths_yupikidpcontroller.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_$(DEVICE_SKU)/mixer_paths_yupikidpcontroller.xml \
