...
ifeq ($(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX),$(filter $(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX),msmnile_au msmnile_au_ota))
...
-include $(TOPDIR)vendor/qcom/opensource/audio-hal/primary-hal/configs/msmnile_au/msmnile_au.mk
else ifeq ($(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX),$(filter $(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX),sm6150_au sm6150_au_ota))
